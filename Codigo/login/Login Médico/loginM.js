...
function initLoginApp () {
    ...
    usuarioCorrenteJSON = sessionStorage.getItem('usuarioCorrenteM');
    ...
    var usuariosJSON = localStorage.getItem('loginMedico');
    ...
    if (!usuariosJSON) {  // Se NÃO há dados no localStorage
        ...
        localStorage.setItem('loginMedico', JSON.stringify (dadosIniciais));
    }
...
function loginUser (login, senha) {
    ...
    for (var i = 0; i < db_usuarios.usuarios.length; i++) {
        ...
        if (login == usuario.login && senha == usuario.senha) {
            ...
            sessionStorage.setItem ('usuarioCorrenteM', JSON.stringify (usuarioCorrente));
...
function addUser (nome, login, senha, email) {
    ...
    localStorage.setItem('loginMedico', JSON.stringify (db_usuarios));
}
